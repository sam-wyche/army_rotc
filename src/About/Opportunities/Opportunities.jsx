...
import data from "./OpportunitiesData"
import Modal from "./OpportunitiesModal";

const Opportunities = () => {

    const [nextItems] = useState(4)
            ...
            <div className="flex items-center gap-4 flex-wrap mt-0">
                {
                    portfolios?.slice(0, nextItems)?.map((portfolio,index)=>(
                        <div key={index}
                            ...
                            className="group max-w-full sm:w-[48.5%] md:w-[31.8%] lg:w-[48%] relative z-[1] border border-[2px] rounded-[5px]"
                        >
                            <figure>
