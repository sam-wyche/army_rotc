...
const Header = () => {
    ...
    return <header ref={headerRef} className="w-full h-[80px] leading-[80] flex intems-center bg-[#151515]">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="menu" ref={menuRef} onClick={toggleMenu}>
                    <ul className="flex items-center gap-10 h-[80px]">
                        <li>
                            <a onClick={handleClick} className="text-headerTextColor font-[600]" href="#about">About</a>
                        </li>
                        <li>
                            <a onClick={handleClick} className="text-headerTextColor font-[600]" href="#services">Timeline</a>
                        </li>
                        <li>
                            <a onClick={handleClick} className="text-headerTextColor font-[600]" href="#portfolio">Branches</a>
                        </li>
                        <li>
                            <a onClick={handleClick} className="text-headerTextColor font-[600]" href="#contact">Contact</a>
                        </li>
                    </ul>
                </div>
                {/* ============ menu end ========== */}
